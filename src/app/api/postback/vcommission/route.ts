...
function mapStatus(raw?: string | null) {
  ...
  if (
    ...
    ["approved", "confirmed", "paid", "payable", "success", "validated"].includes(
  ...
  if (
    ...
    ["rejected", "cancelled", "canceled", "declined", "failed", "invalid"].includes(
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    console.error("VCOMMISSION_POSTBACK_ERROR", error);

    return NextResponse.json(

      { error: "vCommission postback failed" },
